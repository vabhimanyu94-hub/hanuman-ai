...
# --- CLEAN INTERFACE CSS FOR PERFECT BOTTOM LAYOUT ---
st.markdown("""
<style>
    /* Unnecessary headers and stream elements hide styling */
    ...
    .stAppViewMain > div > div {
        ...
        padding-bottom: 220px !important; /* Space so chat doesn't hide behind bar */
    }
    
    /* 🛠️ FIXED CHAT INPUT LAYOUT PLACEMENT */
    ...
    /* 🛠️ ULTRA CLEAN FIXED MINIMAL UPLOADER (Just above input box, zero clutter) */
...
# --- SIMPLIFIED BALANCED BOTTOM LAYOUT COMPONENTS ---

# 1. Plain Text Minimalist Uploader (Sits neatly right above input box)
uploaded_file = st.file_uploader("➕ Attach File", type=["png", "jpg", "jpeg", "txt", "py"], label_visibility="collapsed")

if uploaded_file is not None:
    st.success(f"📎 Attached: {uploaded_file.name}")

# 2. Primary Chat Field Input
prompt = st.chat_input("Hanuman Ji se kuch bhi poochhein...")

# --- CORE BACKEND LOGIC PROCESSING PIPELINE ---
